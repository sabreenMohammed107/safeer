        ...
        <div id="rooms_content">
            ...
            <div class="rooms">
                ...
                <div class="row mx-0 align-items-center text-center">
                    ...
                    <div class="col-xl-1 col-sm-12 col-md-6 p-0">
                        <button class="btn rooms_button" data-bs-toggle="modal"
                            data-bs-target="#staticBackdrop{{ $Room->id }}">
                            {{-- <a href="{{url(" /safeer/room/$Room->id/book/1")}}">book</a> --}}
                            <a>book</a>
                        </button>
                        <div class="modal fade addFavDialog" id="staticBackdrop{{ $Room->id }}"
                            data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                            aria-labelledby="staticBackdropLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <h3>Book Now</h3>
                                        <h2>Be Noted !!</h2>
                                        <h5>You will Lose Previous Booking Data</h5>
                                    </div>
                                    <div class="modal-footer">
            ...
            <div class="rooms">
                ...
                <div class="row mx-0 align-items-center text-center">
                    ...
                    <div class="col-xl-1 col-sm-12 col-md-6 p-0">
                        <button class="btn rooms_button" data-bs-toggle="modal"
                            data-bs-target="#staticBack{{ $Room->id }}drop">
                            {{-- <a href="{{url(" /safeer/room/$Room->id/book/1")}}">book</a> --}}
                            <a>book</a>
                        </button>
                        <div class="modal fade addFavDialog" id="staticBack{{ $Room->id }}drop"
                            data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                            aria-labelledby="staticBackdropLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                        ...
                        {{-- <button class="btn rooms_button"> <a href="{{url(" /safeer/room/$Room->id/book/2")}}">book</a>
                        </button> --}}
                    </div>
            ...
            <div class="rooms">
                ...
                <div class="row mx-0 align-items-center text-center">
                    ...
                    <div class="col-xl-1 col-sm-12 col-md-6 p-0">
                        <button class="btn rooms_button" data-bs-toggle="modal"
                            data-bs-target="#static{{ $Room->id }}Backdrop">
                            {{-- <a href="{{url(" /safeer/room/$Room->id/book/1")}}">book</a> --}}
                            <a>book</a>
                        </button>
                        <div class="modal fade addFavDialog" id="static{{ $Room->id }}Backdrop"
                            data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                            aria-labelledby="staticBackdropLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                        ...
                        {{-- <button class="btn rooms_button"> <a href="{{url(" /safeer/room/$Room->id/book/3")}}">book</a>
                        </button> --}}
                    </div>

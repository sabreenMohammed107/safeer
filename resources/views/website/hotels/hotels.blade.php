                ...
                <div class="col-sm-12 col-md-6 col-xl-2 p-s-0 ">
                    ...
                    <div class="choices">
                        ...
                        <select class="form-select" name="country_id" aria-label="Default select example">
                            ...
                            <option value="{{ $Country->id }}" @if (session()->has('sessionArr')) {{
                                Session::get('sessionArr')['country_id'] == $Country->id ? 'selected' : '' }} @endif>
        ...
        <div class="col-sm-12 col-xl-9" id="hotels_content">
            ...
            <div class="row mx-0">
                ...
                <nav aria-label="Page navigation page_pagination example">
                    <ul class="pagination">
                        @for ($i = 0; $i < $Count / 6; $i++) @if($Count> 6)
                            <li class="page-item page-num" data-val="{{ $i + 1 }}"><a class="page-link" href="#">{{ $i +
                                    1 }}</a></li>
                            @endif
                            @endfor

                    ...
                    <div class="col-sm-12 col-md-6">
                        ...
                        @if (count($ToursCost) > 0)
                            ...
                            @foreach ($ToursCost as $index => $Tour)
                                ...
                                <h6 class="bg-light-info px-3 py-1">
                                    ...
                                    @else
                                        {{ $Tour->ar_name ?? '' }}
                                    @endif <span class="">{{ $Tour->tour_date }}</span>
                                </h6>
                                <div class="passenger_info">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-6 col-xl-4">
                                            ...
                                            <input type="text" name="tour_adults_sal[{{ $index }}][]" required
                                        ...
                                        <div class="col-sm-12 col-md-6 col-xl-4">
                                            ...
                                            <input type="text" name="tour_adults_mobile[{{ $index }}][]"
                                                required class="form-control" placeholder="{{ __('links.mobile') }} ">
                                        </div>
                                        ...
                                        <div class="col-sm-12 col-md-8">
                                            ...
                                            <input type="text" name="tour_pickup_point[{{ $index }}]" required
                                                class="form-control" placeholder="{{ __('links.pickupP') }}">
                                        </div>
                                    </div>
                                    <h6>
                                        @if (LaravelLocalization::getCurrentLocale() === 'en')
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-6 col-xl-4">
                                                ...
                                                <input type="text" name="tour_adults_sal[{{ $index }}][]"
                                                    required class="form-control" placeholder="{{ __('links.mr') }} MR"
                                                    aria-label="First name">
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-xl-4">
                                                <label class="form-label">{{ __('links.cName') }} </label>
                                                ...
                                                <input type="text" name="tour_adults_name[{{ $index }}][]"
                                                    required class="form-control" placeholder="{{ __('links.cName') }} ">
                                            </div>
                                            <div class="col-sm-12 col-md-6 col-xl-4">
                                                <label class="form-label">{{ __('links.mobile') }}</label>
                                            ...
                                            <div class="col-sm-12 col-md-8">
                                                ...
                                                <input type="text" name="tour_adults_email[{{ $index }}][]"
                                                    required class="form-control" placeholder="{{ __('links.email') }} ">
                                            </div>
                                        </div>
                                    @endfor
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-6">
                                                ...
                                                <input type="hidden" name="tour_child_age[{{ $index }}][]"
                                                    required value="{{ explode(',', $Tour->ages)[$i] }}" />
                                            </div>
                                        </div>
                                    @endfor
                                    <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        @if (LaravelLocalization::getCurrentLocale() === 'en')
                                            <p class="mb-0">Car Model:
                                                <strong>{{ $TransferCost->model_enname }}</strong></p>
                                            <p class="mb-0">Car Capacity:
                                                <strong>{{ $TransferCost->capacity }}</strong></p>
                                            <p class="mb-0">Class Type:
                                                <strong>{{ $TransferCost->class_enname }}</strong></p>
                                            <p class="mb-0">Starting point (from):
                                                <strong>{{ $TransferCost->from_location_enname }}</strong></p>
                                            <p class="mb-0">Route Destination (to):
                                                <strong>{{ $TransferCost->to_location_enname }}</strong></p>
                                            <p class="mb-0">Transportation Fees:
                                                <strong>{{ $TransferCost->person_price }}$</strong></p>
                                        @else
                                            <p class="mb-0">موديل السيارة:
                                                <strong>{{ $TransferCost->model_arname ?? '' }}</strong></p>
                                            <p class="mb-0">سعة السيارة: <strong>{{ $TransferCost->capacity }}</strong>
                                            </p>
                                            <p class="mb-0">فئه السيارة:
                                                <strong>{{ $TransferCost->class_arname ?? '' }}</strong></p>
                                            <p class="mb-0">نقطه البداية (من):
                                                <strong>{{ $TransferCost->from_location_arname ?? '' }}</strong></p>
                                            <p class="mb-0">نقطة الوصول (الي):
                                                <strong>{{ $TransferCost->to_location_arname ?? '' }}</strong></p>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-6 col-xl-4">
                                            ...
                                            <input type="text" name="transferName"
                                                value="{{ session()->get('SiteUser')['Name'] }}" class="form-control"
                                                required="required" placeholder="{{ __('links.cName') }}">
                                        </div>
                                        <div class="col-sm-12 col-md-6 col-xl-4">
                                            <label class="form-label">{{ __('links.mobile') }} </label>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <input type="email" name="transferEmail"
                                                value="{{ session()->get('SiteUser')['Email'] }}" class="form-control"
                                                required="required" placeholder="{{ __('links.email') }}">
                                        </div>
                                        <div class="col-sm-12">
                        ...
                        <div class="">
                            <div class="row">
                                ...
                                <div class="form-check mb-3 " style="padding: 0px 10px">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="passenger_info">
                                ...
                                @foreach ($ToursCost as $idx => $TourRec)
                                    <div class="booking_info_card">
                                        <div class="text-end mb-3"><a class="del-hotel delete_trash"
                                                href="{{ url("/cart/$TourRec->id") }}"><i
                                                    class="fa-solid fa-trash"></i></a></div>
                                        <div class="booking_info_card_info">
                                            <div class="info_image">
                                                <img src="{{ asset('uploads/tours') }}/{{ $TourRec->banner }}"
                                                    alt=" blogimage" />
                                            </div>
                                            <div class="info_title">
                                                <div class="card_info">
                                                    @if (LaravelLocalization::getCurrentLocale() === 'en')
                                                        ...
                                                        <span> <i
                                                                class="fa-solid fa-location-dot"></i>{{ $TourRec->en_country }}
                                                            <span>|</span> {{ $TourRec->en_city }}</span>
                                                    @else
                                                        <h6> <a href="{{ url('/hotels/') }}"
                                                                class="">{{ $TourRec->ar_name ?? '' }}</a></h6>
                                                        <span> <i
                                                                class="fa-solid fa-location-dot"></i>{{ $TourRec->ar_country ?? '' }}
                                        ...
                                        <div class="remain_info mb-3">
                                            ...
                                            <p class="mb-0 pb-0">
                                                {{ $TourRec->adults_count }} X {{ __('links.adult') }} <span
                                                    class=" text-end">{{ $TourRec->adults_count }} X
                                                    ${{ $TourRec->tour_person_cost }}<br><span
                                                        class="fw-bold">${{ $TourRec->adults_count * $TourRec->tour_person_cost }}</span></span>
                                            </p>
                                            <br>
                                            <p class="mb-0 pb-0">
                                                @if (LaravelLocalization::getCurrentLocale() === 'en')
                                                    {{ $TourRec->children_count - ($TotalPaidPersons[$idx] - $TourRec->adults_count) }}
                                                    X Free Childs (< 2 years) <span class="">Free</span><br>
                                                    @else
                                                        {{ $TourRec->children_count - ($TotalPaidPersons[$idx] - $TourRec->adults_count) }}
                                                        X اطفال مجاني (< سنتين) <span class="">مجاني</span><br>
                                                @endif
                                            </p>
                                            <br>
                                            <p class="mb-0 pb-0">
                                                @if (LaravelLocalization::getCurrentLocale() === 'en')
                                                    {{ $TotalPaidPersons[$idx] - $TourRec->adults_count }} X Paid Childs
                                                    <span
                                                        class=" text-end">{{ $TotalPaidPersons[$idx] - $TourRec->adults_count }}
                                                        X ${{ $TourRec->tour_person_cost }} <br> <span
                                                            class="fw-bold text-end">${{ ($TotalPaidPersons[$idx] - $TourRec->adults_count) * $TourRec->tour_person_cost }}</span></span><br>
                                                @else
                                                    {{ $TotalPaidPersons[$idx] - $TourRec->adults_count }} X اطفال مدفوعة
                                                    <span
                                                        class=" text-end">{{ $TotalPaidPersons[$idx] - $TourRec->adults_count }}
                                                        X ${{ $TourRec->tour_person_cost }} <br> <span
                                                            class="fw-bold text-end">${{ ($TotalPaidPersons[$idx] - $TourRec->adults_count) * $TourRec->tour_person_cost }}</span></span><br>
                                            ...
                                            <p class="mb-0 pb-0" style="border-top: 1px solid rgb(184, 184, 184)">
                                                <span
                                                    class=" text-end fw-bold">${{ $TotalPaidPersons[$idx] * $TourRec->tour_person_cost }}</span><br>
                                            </p>
                                            <br>
                                            <div class="grand_total">
                                                <h6>
                                                ...
                                                <span class="h6">
                                                    ${{ $TotalPaidPersons[$idx] * $TourRec->tour_person_cost }}</span></span>
                                            </div>
                            ...
                            @if (count($VisasCost) > 0)
                                ...
                                <div class="booking_info_card">
                                    <div class="text-end mb-3"><a class="del-hotel delete_trash"
                                            href="{{ url('/cart/visa') }}"><i class="fa-solid fa-trash"></i></a></div>
                                    <div class="remain_info mb-3">
                                        <h5>{{ __('links.visa') }} </h5>
                            ...
                            <div class="remain_info">
                                <p class="mb-0 pb-0">
                                    ...
                                    @endif <span
                                        class=" text-end BeforeT_txt">${{ number_format($TotalCost + $TotalToursFees + $TotalTransferCost + $TotalVisasCost, 2, '.', '') }}
                                    </span><br>
                                </p>
                                <br>
                                <p class="mb-0 pb-0">
                                    ...
                                    @endif ({{ $tax_percentage }}%) <span class=" text-end"><span

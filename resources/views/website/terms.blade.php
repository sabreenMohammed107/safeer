    ...
    <section class="investigtion">
        ...
        <div class="container__content">
            ...
            <div class="mt-5">
                ...
                <h2 _ngcontent-serverapp-c181="" class="d-flex align-items-center line-height-normal mb-4 pb-2"
                    style="border-bottom:1px solid #ddd ">
                    <i class="fa-solid fa-circle-arrow-right px-2"></i> <span>دعم التاشيرات</span>
                </h2>


                <p class="px-2">
                    - لن يكون Safer.Travel ملزمًا بطلب أي وثائق تأشيرة من الفندق لأي حجوزات لم يتم دفع ثمنها بالكامل.
                    - سيطلب Safer.Travel مستندات التاشيرات هذه من الفندق عند موافقتك على رسوم 10Eur في حالة إلغاء الحجز.
                    - سوف يبذل Safer.Travel قصارى جهده لتلبية طلبك ولكن ليس من المضمون أن يستجيب الفندق لطلب مستند التاشيرات الخاص بك.
                    - لا يتحكم Safer.Travel في أي رسوم قد يفرضها الفندق على مستندات دعم التاشيرات.
                    - في حالة قيام فندق بفرض رسوم على مستندات دعم التاشيرات ، يتوقع Safer.Travel أن تقوم الوكالة بتسديد الدفعة ذات الصلة مباشرة إلى الفندق.
                ...
                <div class="mt-5">
                    ...
                    <p class="px-2">قد يتم تسجيل المكالمات الهاتفية إلى Safer.Travel لتمكيننا من مراقبة خدماتنا وتحسينها.
                        ...
                        التحويلات
                        1- لا يمكن حجز الإنتقالات بشكل منفصل.
                        2- لا يمكن حجز الإنتقالات إلا كإضافة إلى حجوزات الفنادق.

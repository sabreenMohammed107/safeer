        ...
        <div class="booking_details">
            <div class="row mx-0">
                <div class=" col-xl-6 col- md-6 col-sm-12 p-0">
                    <div class="images"
                        style="background-image:url('@if ($Company->book_img) {{ asset("
                                            uploads/company/$Company->book_img") }} @else {{ asset('/website_assets/images/homePage/slider-mask.webp') }} @endif') ">
            ...
            <div class="row mx-0">
                ...
                <div class=" col-xl-6 col- md-6 col-sm-12">
                    <div class="images image-2"
                        style="background-image:url('@if ($Company->transport_img) {{ asset("
                                            uploads/company/$Company->transport_img") }} @else {{ asset('/website_assets/images/homePage/slider-mask.webp') }} @endif') ">
                        ...
                        <button type="button" class="btn js-modal-btn "
                            data-video-url="{{ $Company->book_transport_vedio }}" data-bs-toggle="modal"

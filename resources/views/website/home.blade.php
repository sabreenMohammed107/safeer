...
<section class="booking">
    ...
    <img loading="lazy" class="w-100" src="{{ asset(" /website_assets/images/homePage/slider-mask.webp") }}"
        alt="slider mask">
            ...
            <div class=" col-xl-6 col- md-6 col-sm-12 p-0">
                <div class="images" style="background-image:url('@if($Company->book_img) {{asset("
                    ...
                    <button type="button" class="btn js-modal-btn " data-video-url="{{$Company->book_tour_vedio}}"
                        ...
                        <img loading="lazy" src="{{ asset('/website_assets/images/homePage/play_button.webp') }}"
...
<section class="investigtion car booking">
    <div class="adventure container">
        <div class="row mx-0">
            ...
            <div class=" col-xl-6 col- md-6 col-sm-12">
                <div class="images image-2" style="background-image:url('@if($Company->transport_img) {{asset("
                    uploads/company/$Company->transport_img")}} @else {{
                    asset("/website_assets/images/homePage/slider-mask.webp") }} @endif') " >
                    <img loading="lazy" src="{{ asset('/website_assets/images/homePage/slider-mask.webp') }}"
                        alt="image mask">
                    <img loading="lazy" src="{{ asset('/website_assets/images/homePage/slider-mask.webp') }}"
                        alt="image mask">
                    ...
                    <button type="button" class="btn js-modal-btn " data-video-url="{{$Company->book_transport_vedio}}"
...
<section class="blog_section ">
            ...
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="pills-all-tab" data-bs-toggle="pill" data-bs-target="#pills-all"
                        type="button" role="tab" aria-controls="pills-all" aria-selected="true"> <a>
                            @if(LaravelLocalization::getCurrentLocale() === 'en')
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link @if($key == $BlogsCategories->count() - 1) nav-link-4 @endif"
                        id="pills-all-tab{{$Category->id}}" data-bs-toggle="pill"
                        data-bs-target="#pills-all{{$Category->id}}" type="button" role="tab"
                        aria-controls="pills-all{{$Category->id}}" aria-selected="true"> <a>
                            @if(LaravelLocalization::getCurrentLocale() === 'en')
    ...
    <div class="filtred_data container">
        <div class="tab-content" id="pills-tabContent">
            ...
            <div class="tab-pane fade show active" id="pills-all" role="tabpanel" aria-labelledby="pills-all-tab">
                <div class="row mx-0">
                    <div class="col-sm-12 col-md-12 col-xl-6">
                        <div class="blog_side">
                            <div class="blog_image left_image"
                                style="background-image: url({{ asset('uploads/blogs') }}/{{$AllBlogs[0]->image}});">
                                <!-- <img src="./images/homePage/blog/blog-1.webp" loading="lazy" alt="blog image"> -->
                            </div>
                            <div class="blog_info">
                                <h5 class="left_heading">
                                    <a
                                        href="{{ LaravelLocalization::localizeUrl('/single-blog/'.$AllBlogs[0]->id.'/'.$AllBlogs[0]->slug) }}">
                                        @if (LaravelLocalization::getCurrentLocale() === 'en')
                                ...
                                <p>
                                    ...
                                    {!! strip_tags(\Illuminate\Support\Str::limit($AllBlogs[0]->en_breif ?? '', $limit =
                                    800, $end = '...')) !!}
                                    @else
                                    {!! strip_tags(\Illuminate\Support\Str::limit($AllBlogs[0]->ar_breif ?? '', $limit =
                                    800, $end = '...')) !!}
                                    @endif
                                </p>
                                <a
                                        ...
                                        <div class="blog_side_right">
                                            <div class="blog_image ">
                                                <img loading="lazy" width="150"
                                                    src="{{ asset('uploads/blogs') }}/{{$AllBlogs[$i]->image}}"
                                                    alt="blog image">
                                            </div>
                                            <div class="blog_info">
                                                <h5>
                                                    <a
                                                        href="{{ LaravelLocalization::localizeUrl('/single-blog/'.$AllBlogs[$i]->id.'/'.$AllBlogs[$i]->slug) }}">
                                                ...
                                                <p>
                                                    ...
                                                    {{ strip_tags(\Illuminate\Support\Str::limit($AllBlogs[$i]->en_breif
                                                    ?? '', $limit = 300, $end = '...')) }}
                                                    @else
                                                    {{ strip_tags(\Illuminate\Support\Str::limit($AllBlogs[$i]->ar_breif
                                                    ?? '', $limit = 300, $end = '...')) }}
                                                    @endif
            ...
            <div class="tab-pane fade" id="pills-all{{$Category->id}}" role="tabpanel"
                aria-labelledby="pills-today-tab{{$Category->id}}">
                <div class="row mx-0">
                    ...
                    <div class="col-sm-12 col-md-12 col-xl-6">
                        <div class="blog_side">
                            <div class="blog_image left_image" style="background-image: url({{asset("
                                /website_assets/images/homePage/blog/{$blog->image}")}});">
                            ...
                            <div class="blog_info">
                                ...
                                <p>
                                    ...
                                    {{ strip_tags(\Illuminate\Support\Str::limit($blog->en_breif ?? '', $limit = 300,
                                    $end = '...')) }}
                                    @else
                                    {{ strip_tags(\Illuminate\Support\Str::limit($blog->ar_breif ?? '', $limit = 300,
                                    $end = '...')) }}
                                    @endif
                            ...
                            <div class="row mx-0">
                                ...
                                <div class="col-sm-12 col-xl-12">
                                    <div class="blog_side_right">
                                        <div class="blog_image">
                                            <img loading="lazy" width="150"
                                                src="{{ asset('uploads/blogs') }}/{{$category_blog->image}}"
                                                alt="blog image">
                                        ...
                                        <div class="blog_info">
                                            ...
                                            <p>
                                                ...
                                                {{ strip_tags(\Illuminate\Support\Str::limit($category_blog->en_text ??
                                                '', $limit = 300, $end = '...')) }}
                                                @else
                                                {{ strip_tags(\Illuminate\Support\Str::limit($category_blog->ar_text ??
                                                '', $limit = 300, $end = '...')) }}
                                                @endif
                                            ...
                                            <a
                                                href="{{ LaravelLocalization::localizeUrl('/single-blog/'.$category_blog->id.'/'.$category_blog->slug) }}">
                                                {{ __('links.readMore') }} <i class="fa-solid fa-angle-right"></i>
                                            </a>
                                        </div>
                                    </div>

        ...
        <div class="col-sm-12 col-md-6">
            ...
            <div class=" slider_details side_right_details">
                ...
                <a href="{{ LaravelLocalization::getLocalizedURL($localVar, route('siteRegister')) }}">
                    {{ __('links.dontHaveAccount') }}<span>{{ __('links.signin_up2') }} </span> </a>
                ...
                <section class="sign_socail">
                    ...
                    <button class="btn">
                        <img src="{{ asset('/website_assets/images/signin-up/socail-logins/google.webp') }}"
                            alt="google logo">

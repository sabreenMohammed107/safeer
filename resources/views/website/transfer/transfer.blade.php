                    ...
                    <div class="filter_labels" id="filtered-menu">
                        ...
                        <div class="row" style="padding-right: 1rem!important;">
                            ...
                            <div class="col-md-10">
                                <label for="">
                                    @if (LaravelLocalization::getCurrentLocale() === 'en')
                                        search by car capacity
                                    @else
                                        البحث بسعة السيارة
                                    @endif
                                </label>
                                <input class="form-control  @if (LaravelLocalization::getCurrentLocale() === 'ar') text-right @endif"
                                    min="1" id="searchId" type="number">
                            </div>

                            <div class="col-md-2 mt-4"><button onclick="fetch_transfer()" class="btn btn-primary"><i
                                    ...
                                    <div class="accordion-body">
                                        @foreach ($pickups as $pickup)
                                            <div class="form-check">
                                                <input class="form-check-input pickups_id" data-id="{{ $pickup->id }}"
                                ...
                                <div id="flush-collapseFive" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        @foreach ($dropoff as $drop)
                                            <div class="form-check">
                                                <input class="form-check-input dropoff_id" data-id="{{ $drop->id }}"
                                                    type="checkbox" value="" id="defaultCheck4">
                                                <label class="form-check-label" for="defaultCheck4">
                                ...
                                <div id="flush-collapseTen" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        @foreach ($CarClass as $car)
                                            <div class="form-check">
                                                <input class="form-check-input CarClass_id" data-id="{{ $car->id }}"
                                                    type="checkbox" value="" id="defaultCheck4">
                                                <label class="form-check-label" for="defaultCheck4">

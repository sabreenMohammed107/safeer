                    ...
                    <div class="card-content">
                        <div class=" card setted_tour_cards ">
                            ...
                            <div class="card-body  setted_info">
                                ...
                                <div class="card_info">
                                    @if (LaravelLocalization::getCurrentLocale() === 'en')
                                        <h6> {{ $HRec->carModel->model_enname ?? '' }} {{ __('links.to') }}
                                            {{ $HRec->locationTo->location_enname ?? '' }} </h6>
                                    @else
                                        <h6> {{ $HRec->carModel->model_arname ?? '' }} {{ __('links.to') }}
                                            {{ $HRec->locationTo->location_arname ?? '' }} </h6>
                                    @endif

                                </div>
                                <h5>
                                    <span class="duartion py-1">
                                        @if (LaravelLocalization::getCurrentLocale() === 'en')
                                            Number of seats
                                        @else
                                            عدد المقاعد
                                        @endif {{ $HRec->carModel->capacity ?? '' }}
                                    </span>
                                </h5>
                                <div class="card_info">
                                    <p style="margin-bottom:0"> <i style="padding: 0 5px 0 5px;"
                                            class="fa-solid fa-suitcase-rolling"></i>{{ __('links.from') }} : <a
                                            href="" style="color:#1C4482;font-weight: 700">
                                            @if (LaravelLocalization::getCurrentLocale() === 'en')
                                    ...
                                    <span>
                                        <p style="margin-bottom:0"> <i style="padding: 0 5px 0 0;"
                                                class="fa-solid fa-suitcase-rolling"></i> {{ __('links.to') }} : <a
                                                href="" style="color:#1C4482;font-weight: 700">
                                                @if (LaravelLocalization::getCurrentLocale() === 'en')
                                ...
                                <div class="card_info">
                                    <p style="margin-bottom:0"> <i style="padding: 0 5px 0 0;"
                                            class="fa-regular fa-clock"></i> {{ __('links.duration') }}: <a
                                            href="" style="color:#1C4482;font-weight: 700">
                                            {{ $HRec->duration }} {{ __('links.hours') }} </a></p>
                                    @if (LaravelLocalization::getCurrentLocale() === 'en')
                                        <span>
                                ...
                                <form action="{{ LaravelLocalization::localizeUrl('/bookTransfer') }}" method="POST">
                                    ...
                                    <div class="booking_info">
                                        ...
                                        <div class="details px-1">
                                            ...
                                            <input type="text" class="form-control transfer_date"
                                                name="transfer_date" />
                                        ...
                                        <div class="details">
                                            ...
                                            <input type="number" name="transfer_adult" value="1"
                            ...
                            <div class="card-body  setted_info">
                                ...
                                <div class="card_info">
                                    @if (LaravelLocalization::getCurrentLocale() === 'en')
                                        <h6> {{ $HPrice->carModel->model_enname ?? '' }} {{ __('links.to') }}
                                            {{ $HPrice->locationTo->location_enname ?? '' }}</h6>
                                    @else
                                        <h6> {{ $HPrice->carModel->model_arname ?? '' }} {{ __('links.to') }}
                                            {{ $HPrice->locationTo->location_arname ?? '' }}</h6>
                                    @endif
                                ...
                                <h5>
                                    <span class="duartion py-1">
                                        ...
                                        @else
                                            عدد المقاعد
                                        @endif {{ $HPrice->carModel->capacity ?? '' }}
                                    </span>
                                </h5>
                                <div class="card_info">
                                    <p style="margin-bottom:0"> <i style="padding: 0 5px 0 5px;"
                                ...
                                <div class="card_info">
                                    <p style="margin-bottom:0"> <i style="padding: 0 5px 0 0;"
                                            class="fa-regular fa-clock"></i> {{ __('links.duration') }}: <a
                                            href="" style="color:#1C4482;font-weight: 700">
                                            {{ $HPrice->duration }} {{ __('links.hours') }} </a></p>
                                    @if (LaravelLocalization::getCurrentLocale() === 'en')
                                        <span>
                                            <p style="margin-bottom:0"><a href=""
                                                    style="color:#1C4482;font-weight: 700"> $
                                    ...
                                    <div class="booking_info">
                                        ...
                                        <div class="details px-1">
                                            ...
                                            <input type="text" id="start_date" placeholder="DD/MM/YYYY"
                                                class="form-control transfer_date" name="transfer_date"
                                                min="2000-01-01" max="2025-12-31" autocomplete="off" />
                                        </div>
                                        <div class="details">
                            ...
                            <div class="card-body  setted_info">
                                ...
                                <div class="card_info">
                                    @if (LaravelLocalization::getCurrentLocale() === 'en')
                                        <h6> {{ $HAlpha->carModel->model_enname ?? '' }} {{ __('links.to') }}
                                            {{ $HAlpha->locationTo->location_enname ?? '' }} </h6>
                                    @else
                                        <h6> {{ $HAlpha->carModel->model_arname ?? '' }} {{ __('links.to') }}
                                            {{ $HAlpha->locationTo->location_arname ?? '' }} </h6>
                                    @endif
                                ...
                                <h5>
                                    <span class="duartion py-1">
                                        ...
                                        @else
                                            عدد المقاعد
                                        @endif {{ $HAlpha->carModel->capacity ?? '' }}
                                    </span>
                                </h5>
                                <div class="card_info">
                                    <p style="margin-bottom:0"> <i style="padding: 0 5px 0 5px;"
                                            class="fa-solid fa-suitcase-rolling"></i>{{ __('links.from') }} :
                                    ...
                                    <span>
                                        <p style="margin-bottom:0"> <i style="padding: 0 5px 0 0;"
                                                class="fa-solid fa-suitcase-rolling"></i> {{ __('links.to') }} :
                                            <a href="" style="color:#1C4482;font-weight: 700">
                                                @if (LaravelLocalization::getCurrentLocale() === 'en')
                                ...
                                <div class="card_info">
                                    <p style="margin-bottom:0"> <i style="padding: 0 5px 0 0;"
                                            class="fa-regular fa-clock"></i> {{ __('links.duration') }}: <a
                                            href="" style="color:#1C4482;font-weight: 700">
                                            {{ $HAlpha->duration }} {{ __('links.hours') }} </a></p>
                                    @if (LaravelLocalization::getCurrentLocale() === 'en')
                                        <span>
                                            <p style="margin-bottom:0"><a href=""
                                                    style="color:#1C4482;font-weight: 700"> $
                                ...
                                <form action="{{ LaravelLocalization::localizeUrl('/bookTransfer') }}"
                                    method="POST">
                                    @csrf

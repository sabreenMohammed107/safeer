        ...
        <div class="container-fluid d-flex align-items-stretch justify-content-between">
            ...
            <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                ...
                <a href="../dist/index.html" class="d-lg-none">
                    <img loading="lazy" alt="Logo" src="{{asset('dist/assets/media/logos/logo-compact.svg')}}" class="mh-40px" />
                </a>
                <!--end::Logo-->
                <!--begin::Aside toggler-->
                ...
                <div class="d-flex align-items-stretch flex-shrink-0">
                    ...
                    <div class="d-flex align-items-center ms-2 ms-lg-3" id="kt_header_user_menu_toggle">
                        ...
                        <div class="cursor-pointer symbol symbol-35px symbol-lg-35px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                            <img loading="lazy" alt="Pic" src="{{asset('dist/assets/media/avatars/300-1.jpg')}}" />
                        </div>
                            ...
                            <div class="menu-item px-3">
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <div class="symbol symbol-50px me-5">
                                        <img loading="lazy" alt="Logo" src="{{asset('dist/assets/media/avatars/300-1.jpg')}}" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Username-->
                                    <div class="d-flex flex-column">
                        ...
                        <div class="card card-xxl-stretch mb-5 mb-xl-8">
                            ...
                            <div class="card-body pb-0">
                                ...
                                <div class="d-flex flex-column justify-content-between h-100">
                                    ...
                                    <!--end::Section-->
                                    <!--begin::Image-->
                                    <div class="flex-grow-1 bgi-no-repeat bgi-size-contain bgi-position-x-center bgi-position-y-bottom card-rounded-bottom max-h-175px min-h-175px" style="background-image:url('assets/media/illustrations/sigma-1/7.webp')"></div>
                                    <!--end::Image-->
                                </div>
                                <!--end::Wrapper-->
                            </div>

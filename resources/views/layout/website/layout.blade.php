                    ...
                    <div class="col-xl-4 col-md-6 col-sm-12">
                        <div class="useful_links">
                            ...
                            <div class="row mx-0">
                                <div class="col-6">
                                    <ul>
                                        <li><i class="fa-solid fa-angle-right"></i><a href="{{ url('/') }}"> Home </a>
                                        </li>
                                        <li><i class="fa-solid fa-angle-right"></i><a href="{{ url('/about') }}">About
                                            </a></li>
                                        <li><i class="fa-solid fa-angle-right"></i><a href="{{ url('/hotels') }}">Hotels
                                            </a></li>
                                ...
                                <div class="col-6">
                                    <ul>
                                        <li><i class="fa-solid fa-angle-right"></i><a href="{{ url('/blogs') }}">Blogs
                                            </a></li>

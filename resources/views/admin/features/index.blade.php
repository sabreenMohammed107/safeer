    ...
    <div class="toolbar" id="kt_toolbar">
        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                <!--begin::Title-->
                <h1 class="text-dark fw-bolder my-1 fs-2">Features</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar">
                        ...
                        <a href="#" class="btn btn-sm btn-primary me-3" data-bs-toggle="modal"
                            data-bs-target="#kt_modal_new_target">Add Feature</a>
                                ...
                                <tr>
                                        ...
                                        <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                            <a href="#">
                                                <div class="symbol-label fs-3 bg-light-danger text-danger">
                                                    <img src="{{ asset('uploads/features') }}/{{ $row->icon }}"
                                                        class="w-100" alt="">
                                                </div>
                                            </a>
                                        </div>
                                    ...
                                    <td>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <span class="symbol-label">{{ $row->en_feature }}</span>
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                ...
                                                <form id="delete_{{ $row->id }}"
                                                    action="{{ route('features.destroy', $row) }}" method="POST"
                                                    style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                            ...
                                            <div class="modal-content rounded">
                                                ...
                                                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                                                    ...
                                                    <form id="kt_modal_update_target_updateForm" class="form"
                                                        action="{{ route('features.update', $row->id) }}" method="post"
                                                        ...
                                                        <div class="mb-13 text-center">
                                                            <!--begin::Title-->
                                                            <h1 class="mb-3">Update Feature</h1>
                                                            <!--end::Title-->
                                                        ...
                                                        <div class="mb-7">
                                                            ...
                                                            <div class="mt-1">
                                                                ...
                                                                <div class="image-input image-input-outline"
                                                                    ...
                                                                    style="background-image: url(' {{ asset('uploads/features') }}/{{ $row->icon }}')">
                                                        ...
                                                        <div class="d-flex flex-column mb-8 fv-row">
                                                            ...
                                                            <div class="d-flex flex-column mb-8">
                                                                <label class="fs-6 fw-bold mb-2">En Feature</label>
                                                                <textarea class="form-control form-control-solid" rows="3" name="en_feature" placeholder="Type En feature">{{ $row->en_feature }}</textarea>
                                                            </div>
                                                            <!--end::Input group-->

                                                            <!--begin::Input group-->
                                                            <div class="d-flex flex-column mb-8">
                                                                <label class="fs-6 fw-bold mb-2">Ar Feature</label>
                                                                <textarea class="form-control form-control-solid" rows="3" name="ar_feature" placeholder="Type Ar feature">{{ $row->ar_feature }}</textarea>
                                                            </div>
                                                            {{-- select --}}
                                                            <div>
    ...
    <div class="modal fade" id="kt_modal_new_target" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <!--begin:Form-->
                    <form id="kt_modal_new_target_form" class="form" action="{{ route('features.store') }}"
                        method="post" enctype="multipart/form-data">
                        @csrf
                        <!--begin::Heading-->
                        <div class="mb-13 text-center">
                            <!--begin::Title-->
                            <h1 class="mb-3">Set Feature</h1>
                            <!--end::Title-->
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <div class="d-flex flex-column mb-8">
                                <label class="fs-6 fw-bold mb-2">En Feature</label>
                                <textarea class="form-control form-control-solid" rows="3" name="en_feature" placeholder="Type En feature"></textarea>
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="d-flex flex-column mb-8">
                                <label class="fs-6 fw-bold mb-2">Ar Feature</label>
                                <textarea class="form-control form-control-solid" rows="3" name="ar_feature" placeholder="Type Ar feature"></textarea>
                            </div>
                            {{-- select --}}
                            <div id="xx">
                                <label class="fs-6 fw-bold form-label mt-3">

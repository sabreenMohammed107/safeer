...
@section('content')
    ...
    <div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
            ...
            <div class="card card-flush">
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar">
                        <!--begin::Add customer-->
                      	<!--begin::Add product-->
											<a href="{{ route('visa.create') }}" class="btn btn-primary">Add Visa</a>
											<!--end::Add product-->
                       ...
                       <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-200px">visa type enname</th>

                                <th class="text-end min-w-70px">visa type arname</th>
     ...
     <tr>
        ...
        <form id="delete_{{$row->id}}" action="{{ route('visa.destroy', $row->id) }}"  method="POST" style="display: none;">
        @csrf
        @method('DELETE')

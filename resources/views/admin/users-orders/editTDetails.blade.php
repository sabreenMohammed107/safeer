<div class="d-flex flex-column gap-7 gap-lg-10">
                    ...
                    @foreach ($persons as $index => $person)
                        ...
                        <tr>
                            ...
                            <td class="text-end pe-0">
                                ...
                                <form id="delete_{{ $person->id }}" style="display: inline-block" action="{{ route('deleteTourPersons') }}"
                                    method="POST" >
                                    @csrf
                                    ...
                                    <button type="submit" class="menu-link px-3" style="border: none" >Delete</button>
                                </form>
                            </td>
    ...
    <!--end::General options-->
     ...
     <!--begin::Modal - New Target-->
 <div class="modal fade" id="add_adult_child" tabindex="-1"
 aria-hidden="true">
 <!--begin::Modal dialog-->
 <div class="modal-dialog modal-dialog-centered mw-650px">
     <!--begin::Modal content-->
     <div class="modal-content rounded">
         ...
         <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
             <!--begin:Form-->
             <form id="kt_modal_update_target_updateForm" class="form"
                 action="{{ route('AddChildTourPersons') }}" method="post"
                 enctype="multipart/form-data">
                 @csrf
...
<!--end::Modal - New Target-->
 ...
 <!--begin::Modal - New Target-->
 <div class="modal fade" id="add_adult" tabindex="-1"
    aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <!--begin::Modal content-->
        <div class="modal-content rounded">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <!--begin:Form-->
                <form id="kt_modal_update_target_updateForm" class="form"
                    action="{{ route('AddAdultTourPersons') }}" method="post"
                    enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <div class="d-flex flex-column mb-8">
                            ...
                            <input type="text" name="person_salutation"
                            placeholder="Mr"
                                class="form-control form-control-solid"
                                value="{{ old('person_salutation') }}" />
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="d-flex flex-column mb-8">

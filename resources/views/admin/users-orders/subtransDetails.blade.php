                    ...
                    <form id="kt_modal_update_target_updateForm" class="form"
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <div class="d-flex flex-column mb-8">
                                ...
                                <input type="date" name="transfer_date" class="form-control form-control-solid @error('transfer_date') is-invalid @enderror"
                            ...
                            <div class="d-flex flex-column mb-8">
                                ...
                                <input type="number" name="capacity" class="form-control form-control-solid @error('capacity') is-invalid @enderror"
                            ...
                            <div class="d-flex flex-column mb-8">
                                <label class="fs-6 fw-bold mb-2">Select transfer - model -capacity</label>
                                <select  class="form-select form-select-solid "
                                data-control="select2" data-placeholder="Select an option" required
                                data-show-subtext="true" data-live-search="true" name="transfer_id" >
                                <option value=""></option>
                                @foreach ($transfers as $transfer)
                                    <option value="{{ $transfer->id }}"> Model : {{ $transfer->carModel->model_arname }} /  Capacity : {{  $transfer->carModel->capacity }}
                                        / From :{{  $transfer->locationFrom->location_enname ?? '' }} / To : {{  $transfer->locationTo->location_enname ?? '' }} / Price : {{ $transfer->person_price }}
                                    </option>
                                @endforeach
                            </select>
                            </div>
                            <div class="d-flex flex-column mb-8">
                                ...
                                <input type="text" name="hotel_name" class="form-control form-control-solid @error('hotel_name') is-invalid @enderror"
                            ...
                            <div class="row trans-holder" style="display: none;">
                                <div class="col-sm-12 col-md-12">
                                    ...
                                    <div class="details px-1">
                                        <input type="date" id="return_date"  placeholder="DD/MM/YYYY"

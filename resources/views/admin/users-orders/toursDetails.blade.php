...
<th class="min-w-200px">tour_name</th>
<th class="min-w-100px">tour_type</th>

<th class="text-end min-w-70px">tour_cost</th>
<th class="text-end min-w-100px">tour_date</th>

<th class="text-end min-w-100px">adults_count</th>
<th class="text-end min-w-70px">children_count</th>

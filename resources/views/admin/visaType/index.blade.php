    ...
    <div class="toolbar" id="kt_toolbar">
        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                <!--begin::Title-->
                <h1 class="text-dark fw-bolder my-1 fs-2">Visa Type</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb fw-bold fs-base my-1">
                    ...
                    <li class="breadcrumb-item text-muted">Visa Type</li>
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar">
                        ...
                        <a href="#" class="btn btn-sm btn-primary me-3" data-bs-toggle="modal"
                            data-bs-target="#kt_modal_new_target">Add Visa Type</a>
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                ...
                                                <form id="delete_{{ $row->id }}"
                                                    action="{{ route('visaType.destroy', $row) }}" method="POST"
                                                    style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                            ...
                                            <div class="modal-content rounded">
                                                ...
                                                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                                                    ...
                                                    <form id="kt_modal_update_target_updateForm" class="form"
                                                        action="{{ route('visaType.update', $row->id) }}" method="post"
                                                        ...
                                                        <div class="mb-13 text-center">
                                                            <!--begin::Title-->
                                                            <h1 class="mb-3">Update VisaType</h1>
                                                            <!--end::Title-->
            ...
            @endforeach
                                                        ...
                                                        <div class="d-flex flex-column mb-8 fv-row">
                                                            ...
                                                            <div class="d-flex flex-column mb-8">
                                                                ...
                                                                <textarea class="form-control form-control-solid" rows="3" name="en_type" placeholder="Type En name">{{ $row->en_type }}</textarea>
                                                            </div>
                                                            <!--end::Input group-->
                                                            ...
                                                            <div class="d-flex flex-column mb-8">
                                                                ...
                                                                <textarea class="form-control form-control-solid" rows="3" name="ar_type" placeholder="Type Ar name">{{ $row->ar_type }}</textarea>
                                                            </div>
    ...
    <div class="modal fade" id="kt_modal_new_target" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <!--begin:Form-->
                    <form id="kt_modal_new_target_form" class="form" action="{{ route('visaType.store') }}"
                        method="post" enctype="multipart/form-data">
                        @csrf
                        <!--begin::Heading-->
                        <div class="mb-13 text-center">
                            <!--begin::Title-->
                            <h1 class="mb-3">Set Visa type</h1>
                            <!--end::Title-->
        ...
        <select required class="form-select form-select-solid "
            ...
            @endforeach
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <div class="d-flex flex-column mb-8">
                                <label class="fs-6 fw-bold mb-2">En Name</label>
                                <textarea class="form-control form-control-solid" rows="3" name="en_type" placeholder="Type En name"></textarea>
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="d-flex flex-column mb-8">
                                <label class="fs-6 fw-bold mb-2">Ar Name</label>
                                <textarea class="form-control form-control-solid" rows="3" name="ar_type" placeholder="Type Ar name"></textarea>
                            </div>

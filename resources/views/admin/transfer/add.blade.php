    ...
    <div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
        ...
        <div class="container-xxl">
            <form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row"
                action="{{ route('transfer.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                                            ...
                                            <div class="fv-row w-100 flex-md-root">
                                                ...
                                                <select required class="form-select form-select-solid "
                                                    ...
                                                    @foreach ($transferFrom as $transferF)
                                                        <option value="{{ $transferF->id }}">{{ $transferF->location_enname }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            <div class="fv-row w-100 flex-md-root">
                                                ...
                                                <select required class="form-select form-select-solid" name="to_location_id"
                                                    ...
                                                    @foreach ($transferTo as $transferT)
                                                        <option value="{{ $transferT->id }}">{{ $transferT->location_enname }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            <div class="fv-row w-100 flex-md-root">
                                                ...
                                                <select  class="form-select form-select-solid"
                                                    ...
                                                    @foreach ($carModel as $carMod)
                                                        <option value="{{ $carMod->id }}">{{ $carMod->model_enname }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            <div class="fv-row w-100 flex-md-root">
                                                ...
                                                <select  class="form-select form-select-solid"
                                                    ...
                                                    @foreach ($carClass as $carclas)
                                                        <option value="{{ $carclas->id }}">{{ $carclas->class_enname }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="d-flex flex-wrap gap-5">
                                           ...
                                           <div class="fv-row w-100 flex-md-root">
                                            ...
                                            <input required type="number" min="1"
                                                ...
                                                placeholder="person_price" value="1" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->

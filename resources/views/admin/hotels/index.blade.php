    ...
    <div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
     ...
     <tr>
      ...
      <span class="symbol-label"
          ...
          style="background-image:url({{ asset('uploads/hotels') }}/{{ $row->hotel_logo }});"></span>
  </a>
  <!--end::Thumbnail-->
                <div class="ms-5">
                    <!--begin::Title-->
                    <a href="#" class="text-gray-800 text-hover-primary fs-5 fw-bolder mb-1"
                    data-kt-ecommerce-category-filter="category_name" >{{ $row->hotel_enname }}</a>
                    <!--end::Title-->
                </div>
            </div>
        </td>
        ...
        <td class="text-end pe-0" data-order="15">
            <input type="hidden" name="" id=""  data-kt-ecommerce-category-filter="category_id" value="{{$row->id}}" >
            <span class="fw-bolder ms-3">{{ $row->type->en_room_type ??'' }}</span>
        </td>
        <!--end::Qty=-->
        <!--begin::Price=-->
        <td class="text-end pe-0">
            <span class="fw-bolder text-dark">{{ $row->city->en_city ?? '' }}</span>
        </td>
        <!--end::Price=-->
        ...
        <form id="delete_{{$row->id}}" action="{{ route('hotels.destroy', $row->id) }}"  method="POST" style="display: none;">
        @csrf
        @method('DELETE')
...
<select name="room_type_id"  required aria-label="Select a room" data-control="select2" data-placeholder="Select a room..." data-dropdown-parent="#kt_modal_new_targetEdit{{$row->id}}" class="form-select form-select-solid fw-bolder">
    <option value="" ></option>
...
<div class="d-flex flex-column mb-8 fv-row">
    ...
    <label class="d-flex align-items-center fs-6 fw-bold mb-2">
        <span class="required">Room No</span>
        <i class="fas fa-exclamation-circle ms-2 fs-7"
            data-bs-toggle="tooltip"
            title="Enter Room No"></i>
    </label>
    <!--end::Label-->

    ...
    <div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
        ...
        <div class="container-xxl">
            <form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row"
                action="{{ route('user-role.update', $row->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <!--begin::Aside column-->
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <select required class="form-select form-select-solid" name="role_id[]"
                                ...
                                <option value="{{ $role->id }}"
                                    @foreach ($userRoles as $sublist) {{ $sublist->pivot->role_id == $role->id ? 'selected' : '' }} @endforeach>
                                    {{ $role->name }}
                                </option>
                            @endforeach
                                </select>

  ...
  <div class="col-sm-12 col-md-12 col-xl-{{$Map[1]}} p-0">
      <div class="row mx-0">
          ...
          <div class="col-md-{{$Map[$key + 2]}} col-sm-12  p-0">
            <div class="card-content">
              <div class=" card">
                <div class="card-body offers_card offer_place_1" style="background-image: linear-gradient(hsla(0, 0%, 0%, 0.3),hsla(0, 0%, 0%, 0.3)) , url({{asset("/website_assets/images/homePage/places_offer/{$Offer->image}")}});">
                  <div class="header_info">

                ...
                <ul class="nav travel_tabs nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        ...
                        <a href="{{ LaravelLocalization::localizeUrl('/transfers') }}">
                            <button class="nav-link" type="button">{{ __('links.transfer') }}</button>
                        </a>

                    </li>
                    <li class="nav-item" role="presentation">
                        {{-- <button class="nav-link" id="visa-tab" data-bs-toggle="tab" data-bs-target="#visa"
                            type="button" role="tab" aria-controls="visa" aria-selected="false">visa payment</button>
                        --}}
                        <a href="{{ LaravelLocalization::localizeUrl('/visa') }}">
                            <button class="nav-link" type="button">{{ __('links.visa') }} </button>
                        </a>
                                ...
                                <div class="row mx-0 p-0">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-xl-3 p-0 ">
                                        ...
                                        <div class="datepicker calender">
                                            ...
                                            <input type="text" id="demo2" name="from_date" class="demo" value="" />
                                        </div>
                                    </div>
                        ...
                        <div class="hotel_details">
                            <div class="row mx-0 p-0">
                                ...
                                <div class="col-sm-12 col-md-6 col-xl-3 p-0 ">
                                    ...
                                    <div class="datepicker calender">
                                        <i class="fa-solid fa-calendar-days"></i>
                                        <input type="text" id="demo3" class="demo" name="datefilter" value="" />
                                    </div>
                                </div>
                        ...
                        <div class="hotel_details">
                            <div class="row mx-0 p-0">
                                ...
                                <div class="col-sm-12 col-md-6 col-xl-3 p-0 ">
                                    ...
                                    <div class="datepicker calender">
                                        <i class="fa-solid fa-calendar-days"></i>
                                        <input type="text" id="demo4" class="demo" name="datefilter" value="" />
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-6 col-xl-2">
                                    <h5> nights</h5>
                    ...
                    <div class="tab-pane fade" id="visa" role="tabpanel" aria-labelledby="visa-tab">
                        <div class="hotel_details">
                            <div class="row">
                                ...
                                <div
                                    class="col-xl-2 col-md-12 col-sm-12 d-flex align-items-center justify-content-center">
